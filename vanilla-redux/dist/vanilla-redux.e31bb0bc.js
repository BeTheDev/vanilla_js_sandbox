...
var btnDecrease = document.querySelector("#decrease"); //Actions

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; //Action Type 함수
...
var render = function render() {
  var state = store.getState(); //현 상태를 불러온다
  //토글 처리
...
store.subscribe(render); //dispatch 액션을 발생시킴
